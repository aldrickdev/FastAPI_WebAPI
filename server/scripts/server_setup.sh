...
sudo apt-get install -y -q python3-pip python3-dev python3-virtualenv
...
# clone the repo:
cd /apps
git clone https://github.com/aldrickdev/FastAPI_WebAPI.git app_repo
